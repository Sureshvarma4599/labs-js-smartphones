...
class SmartPhone{
   ...
   displayFeatures(){
    var myPhone= new SmartPhone("4GB","3800mAH",24000);
    return this.ram +'\n'+this.batteryPower+'\n'+this.price;
   }
...
class AndroidPhone extends SmartPhone{
    ...
    displayFeatures(){
        ...
        const myAndroidPhone= new AndroidPhone("onePlus","4GB","3800mAH",24000)
       // myPhone= new AndroidPhone("oneplus","8GB","5000MaH","45000")
...
class IPhone extends SmartPhone{
    ...
    displayFeatures(){
        const myIphone= new IPhone("iphone 11","4GB","3800mAH",64000)
